...
def calculate_subtotal (adults,juniors):
    adult_subtotal = adults * int(17.50)
    junior_subtotal = juniors + int(11.00)
...
def output_summary(final_total, name, email, order_date, entry_date):
    ...
    print("Number of Junior Tickets: {}".format(final_total.get("num_juniors")))
    ...
    print("Total after discount: £{}".format(final_total.get("after_discount")))
...
final_adult_tickets = int(adult_tickets) + (not_junior)
final_junior_tickets = int(junior_tickets) + (not_junior)
